...
def _retired_track_work_arc() -> int:
    ...
    `./led --json` payload mode itself is still live, current behavior on any normal
    ...
    print("seen-red/led-json-payload-mode/run_fixtures.py: RETIRED-SCAFFOLD 2026-07-25 (ledger")
    print("  row 1271) -- this fixture's ADOPT step used bootstrap/track-work.sh, now a")
    print("  teaching-refusal stub. ./led --json itself is still live; rebuild this fixture's")

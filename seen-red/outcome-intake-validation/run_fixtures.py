...
def _retired_track_work_arc() -> int:
    ...
    The `outcome:` statement-grammar validator itself is still live, current behavior on any
    ...
    print("seen-red/outcome-intake-validation/run_fixtures.py: RETIRED-SCAFFOLD 2026-07-25")
    print("  (ledger row 1271) -- this fixture's ADOPT step used bootstrap/track-work.sh, now a")
    print("  teaching-refusal stub. The `outcome:` validator itself is still live; rebuild this")

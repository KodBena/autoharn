...
def _retired_track_work_arc() -> int:
    ...
    The resource-registry stage-1 behavior itself is still live, current behavior on any normal
    ...
    print("seen-red/resource-registry/run_fixtures.py: RETIRED-SCAFFOLD 2026-07-25 (ledger row")
    print("  1271) -- this fixture's ADOPT step used bootstrap/track-work.sh, now a")
    print("  teaching-refusal stub. The registry behavior itself is still live; rebuild this")

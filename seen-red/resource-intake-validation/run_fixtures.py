...
def _retired_track_work_arc() -> int:
    ...
    The `resource:` intake-validation fix itself is still live, current behavior on any normal
    ...
    print("seen-red/resource-intake-validation/run_fixtures.py: RETIRED-SCAFFOLD 2026-07-25")
    print("  (ledger row 1271) -- this fixture's ADOPT step used bootstrap/track-work.sh, now a")
    print("  teaching-refusal stub. The `resource:` validator itself is still live; rebuild this")

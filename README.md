...
1. **Capability registry (intent SSOT).** What tools, services, venvs, and *blessed*
...
2. **Provenance / accountability ledger.** Attributable links between a git commit, a
...
3. **Logic safety net.** Per-store invariant gates backed by real engines: *classical*

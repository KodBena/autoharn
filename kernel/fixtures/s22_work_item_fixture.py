...
design/S22-WORK-ITEM-LEDGER.md, Fable-authored spec, session be693afb, 2026-07-09) on a THROWAWAY
schema pair in the TOY db (design/S22-WORK-ITEM-LEDGER.md's own witness protocol, items 1-6, run
in order):

...
(vestigial_documentation/design/ORCH-USE-MODE-ENGINE-WIRING.md item 1; ADR-0012 P1) — the same home `engine/ledger_edb.py`
...
finding 51 named in vestigial_documentation/design/ORCH-USE-MODE-ENGINE-WIRING.md: this literal used to hardcode `kernel.principal`

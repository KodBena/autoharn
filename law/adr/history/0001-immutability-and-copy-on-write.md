...
> `law/adr/0001-immutability-and-copy-on-write.md` at commit `ff691bb9bc430ad497d74ff82d580f758a969f99`
> under `design/MAINT-ADR-PORTABILITY-SPEC.md` (tracker `adr-portability-refactor`,
> WP-1, maintainer-ratified 2026-07-13 — the 0001 retirement ruling, previously open at
> §9, closed as retire). Not retro-edited; the lessons this record teaches are chocofarm's
> own — this is a chocofarm-specific technical Decision, not a transferable tenet, and the
> autoharn corpus keeps no live rule descending from it. The surviving slot is
> `law/adr/0001-immutability-and-copy-on-write.md`, now a tombstone pointing here.*

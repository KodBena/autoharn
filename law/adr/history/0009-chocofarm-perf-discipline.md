# History record — ADR-0009's chocofarm-era body (Context through Related, plus the 2026-06-24 amendment)
...
*Zero-context orientation: this is the entire chocofarm-era body of ADR-0009 (Performance
Investigation Discipline) as it stood before the 2026-07-13 portability refactor — the
project's original substrate for the perf/equivalence tenet, native to a numpy/JAX/numba
AlphaZero-search codebase called chocofarm, transferred once already from a browser-tooling
project called LengYue. The parent ADR's own 2026-07-12 amendment (preserved separately at
`history/0009-autoharn-reinstancement-2026-07-12.md`) had already declared this whole body
"illustrative history now, not this project's binding surface" — the portability refactor
completes that declaration by moving the prose out of the live document. Nothing below binds

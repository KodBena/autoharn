...
[design/ORCH-SPEC-TASK-TAXONOMY.md](../design/ORCH-SPEC-TASK-TAXONOMY.md) (§1) names the problem this
...
(the write-time gate and the audit family are later stages, [§7](../design/ORCH-SPEC-TASK-TAXONOMY.md#7-implementation-routing-all-stages-sonnet-executable-from-this-spec)
...
The rows below are **transcribed from [ORCH-SPEC-TASK-TAXONOMY.md §1](../design/ORCH-SPEC-TASK-TAXONOMY.md#1-the-problem-and-the-worked-specimen-the-maintainer-already-owns)**,
...
[ORCH-SPEC-TASK-TAXONOMY.md §4](../design/ORCH-SPEC-TASK-TAXONOMY.md#4-the-polymorphic-predicates--what-the-engine-checks-without-knowing-why)
...
[Stage B](../design/ORCH-SPEC-TASK-TAXONOMY.md#7-implementation-routing-all-stages-sonnet-executable-from-this-spec)'s
...
[ORCH-SPEC-TASK-TAXONOMY.md §3](../design/ORCH-SPEC-TASK-TAXONOMY.md#3-declaring-a-taxonomy--rows-like-everything-else)
...
Stage A of [ORCH-SPEC-TASK-TAXONOMY.md](../design/ORCH-SPEC-TASK-TAXONOMY.md), in full. It does **not**
...
- [ORCH-SPEC-TASK-TAXONOMY.md](../design/ORCH-SPEC-TASK-TAXONOMY.md) — the spec this page implements
...
- [design/ORCH-SPEC-DECOMPOSITION-POLICY.md](../design/ORCH-SPEC-DECOMPOSITION-POLICY.md) — the sibling

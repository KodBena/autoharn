...
- **collaborate** under the harness — through the working standard, the append-only decision
  ...
  ([bootstrap/AUDITOR.md](AUDITOR.md)'s independent second opinion); and
...
[`provenance/HOME-FLIP.md`](../vestigial_documentation/provenance/HOME-FLIP.md)); the complete working surface lives

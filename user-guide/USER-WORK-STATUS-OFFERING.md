...
[omega](../vestigial_documentation/research/foundational-map/06-omega-work-status-sql-anti-corruption-layer.md)'s
...
[omega's `work-status` store](../vestigial_documentation/research/foundational-map/06-omega-work-status-sql-anti-corruption-layer.md)
...
- [omega's work-status precedent](../vestigial_documentation/research/foundational-map/06-omega-work-status-sql-anti-corruption-layer.md) —

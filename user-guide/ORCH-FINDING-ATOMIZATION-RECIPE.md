...
- **[ORCH-SPEC-DECOMPOSITION-POLICY.md](../design/ORCH-SPEC-DECOMPOSITION-POLICY.md) and
  [ORCH-SPEC-TASK-TAXONOMY.md](../design/ORCH-SPEC-TASK-TAXONOMY.md).** These specs govern splitting a
...
- **[design/ORCH-COSIGN-CONVENTION-CROSSCHECK.md](../vestigial_documentation/design/ORCH-COSIGN-CONVENTION-CROSSCHECK.md)** and
  **[observatory/ent/cycle-003.md](../observatory/ent/cycle-003.md)** were checked as the nearest
...
- [design/ORCH-SPEC-DECOMPOSITION-POLICY.md](../design/ORCH-SPEC-DECOMPOSITION-POLICY.md) and
  [design/ORCH-SPEC-TASK-TAXONOMY.md](../design/ORCH-SPEC-TASK-TAXONOMY.md) — the sibling disciplines for
...
- [design/ORCH-COSIGN-CONVENTION-CROSSCHECK.md](../vestigial_documentation/design/ORCH-COSIGN-CONVENTION-CROSSCHECK.md) — the shape
...
- [observatory/ent/cycle-003.md](../observatory/ent/cycle-003.md) §6 — the concrete 93-findings/

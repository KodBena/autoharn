...
5. [USER-GUIDE.md](USER-GUIDE.md) — the adopter's narrative spine; it orders the USER- shelf.
   [design/USER-RECIPES-FAQ.md](USER-RECIPES-FAQ.md) is the intent-keyed index over that shelf ("can I do X?"
...
before it counts as usable knowledge — ([design/ORCH-KR-TITRATION-EXPLORATION.md](../vestigial_documentation/design/ORCH-KR-TITRATION-EXPLORATION.md)),
compound-nominal detection round-trip ([design/ORCH-COMPOUND-NOMINAL-DETECTION.md](../vestigial_documentation/design/ORCH-COMPOUND-NOMINAL-DETECTION.md) and
[-2.md](../vestigial_documentation/design/ORCH-COMPOUND-NOMINAL-DETECTION-2.md) — an Opus infeasibility verdict constructively rebutted with a working detector),
a typed-table constructor experiment testing whether a table's rows can be generated from a
declared type rather than hand-written ([design/ORCH-TYPED-TABLE-EXPERIMENT.md](../vestigial_documentation/design/ORCH-TYPED-TABLE-EXPERIMENT.md)), and the
registry completeness audit ([design/ORCH-REGISTRY-COMPLETENESS-AUDIT-001.md](../vestigial_documentation/design/ORCH-REGISTRY-COMPLETENESS-AUDIT-001.md), a 20-family
...
1. **Re-dispatch two claimed items whose builders never ran** (the prior session hit
   ...
   [design/ORCH-ABC-AUDIT-LOOP-RECIPE.md](ORCH-ABC-AUDIT-LOOP-RECIPE.md) — a document's
...
- The A:B:C attestation loop's two-round cap escalates
  ([design/ORCH-ABC-AUDIT-LOOP-RECIPE.md](ORCH-ABC-AUDIT-LOOP-RECIPE.md)); apply B's round-2 repairs verbatim with an honest

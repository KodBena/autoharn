...
[ORCH-SPEC-RESOURCE-REGISTRY.md](../design/ORCH-SPEC-RESOURCE-REGISTRY.md) (§2) specifies how your project
...
[ORCH-SPEC-RESOURCE-ACCOUNTING.md](../design/ORCH-SPEC-RESOURCE-ACCOUNTING.md) §3 added this fourth tier
...
[stage 2](../design/ORCH-SPEC-RESOURCE-REGISTRY.md#8-implementation-routing-and-witness-plan): this
...
[stage 2](../design/ORCH-SPEC-RESOURCE-REGISTRY.md#8-implementation-routing-and-witness-plan)
...
[stage 2](../design/ORCH-SPEC-RESOURCE-REGISTRY.md#8-implementation-routing-and-witness-plan), unbuilt as
...
[ORCH-SPEC-RESOURCE-REGISTRY.md §2](../design/ORCH-SPEC-RESOURCE-REGISTRY.md#2-declaration--resource-rows-on-the-deployments-own-ledger)'s
...
([ORCH-SPEC-RESOURCE-ACCOUNTING.md](../design/ORCH-SPEC-RESOURCE-ACCOUNTING.md) §3: a prohibition outranks
...
[stage 3](../design/ORCH-SPEC-RESOURCE-REGISTRY.md#8-implementation-routing-and-witness-plan), on witnessed
need).
...
- [ORCH-SPEC-RESOURCE-REGISTRY.md](../design/ORCH-SPEC-RESOURCE-REGISTRY.md) — the spec this template
...
- [ORCH-SPEC-RESOURCE-ACCOUNTING.md](../design/ORCH-SPEC-RESOURCE-ACCOUNTING.md) — the companion spec that

...
[`design/MAINT-PG-HBA-HARDENING.md`](../vestigial_documentation/design/MAINT-PG-HBA-HARDENING.md) (every fact there is witnessed against
...
is in [`design/MAINT-PG-HBA-HARDENING.md`](../vestigial_documentation/design/MAINT-PG-HBA-HARDENING.md) §2–§5.
...
[`design/ORCH-PGAUDIT-EXPLORATION.md`](../vestigial_documentation/design/ORCH-PGAUDIT-EXPLORATION.md) for the full
...
- [`design/MAINT-PG-HBA-HARDENING.md`](../vestigial_documentation/design/MAINT-PG-HBA-HARDENING.md) — the full pg_hba investigation this
  page's FAQ condenses; read it in full before applying anything to a database that matters.
- [`design/ORCH-PGAUDIT-EXPLORATION.md`](../vestigial_documentation/design/ORCH-PGAUDIT-EXPLORATION.md) — the full pgAudit

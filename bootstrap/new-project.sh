...
#   last-change: 2026-07-18T04:23:14Z
...
usage() {
    ...
    echo "          also applies high_watermark_1.sql + s20 through s43, seeds the stamp secret, and" >&2
...
if [ -n "$NEW_WORLD" ]; then
    echo "-- new-world '$NEW_WORLD': applying high_watermark_1.sql + s20 + s21 + s22 + s23 + s24 + s25 + s26 + s27 + s28 + s29 + s30 + s31 + s32 + s33 + s34 + s35 + s36 + s37 + s38 + s39 + s40 + s41 + s42 + s43 to $DB (schema=$SCHEMA kern=$KERN role=$ROLE) --"

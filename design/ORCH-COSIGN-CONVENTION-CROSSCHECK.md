...
observatory/ent/cycle-003.md (internal audit record, not part of this public release) §7, item 2, quotes ent's
...
observatory/ent/cycle-003.md (internal audit record, not part of this public release)'s "DIFF-VS-PRIOR" section — the
...
boundary: it names
[design/ORCH-review-fixpoint-protocol.md](ORCH-review-fixpoint-protocol.md) nowhere directly,
...
**Home: [design/ORCH-review-fixpoint-protocol.md](ORCH-review-fixpoint-protocol.md)**, itself
...
**[design/ORCH-ABC-AUDIT-LOOP-RECIPE.md](ORCH-ABC-AUDIT-LOOP-RECIPE.md)**.
...
- observatory/ent/cycle-003.md (internal audit record, not part of this public release) §7 item 2 — the candidate this
...
- [design/ORCH-review-fixpoint-protocol.md](ORCH-review-fixpoint-protocol.md) — the home this
...
- [design/ORCH-ABC-AUDIT-LOOP-RECIPE.md](ORCH-ABC-AUDIT-LOOP-RECIPE.md) — a second, differently

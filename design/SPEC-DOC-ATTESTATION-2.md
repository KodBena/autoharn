...
written for whoever maintains that gate or the [A:B:C audit-loop recipe](ABC-AUDIT-LOOP-RECIPE.md),
...
- **It does not update the recipe prose in this pass.** [ABC-AUDIT-LOOP-RECIPE.md](ABC-AUDIT-LOOP-RECIPE.md)
...
- [`gates/doc_attestation_presence.py`](../gates/doc_attestation_presence.py) — the gate; its
  ...
  rationale.
- [ABC-AUDIT-LOOP-RECIPE.md](ABC-AUDIT-LOOP-RECIPE.md) — the operator recipe for running the loop

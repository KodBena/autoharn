...
[GPG-TRUST-LAYER-FAQ.md](USER-GPG-TRUST-LAYER-FAQ.md); current honest state (no key on file):
...
- **A new safety mechanism (kernel delta "s27") landed** that catches an administrator quietly
  ...
  [GPG-TRUST-LAYER-FAQ.md](USER-GPG-TRUST-LAYER-FAQ.md)), and it needs your real key to mean
  anything.
...
re-verified this session against [GPG-TRUST-LAYER-FAQ.md](USER-GPG-TRUST-LAYER-FAQ.md) §1–§2):**
...
- **The "does the review flag apply to one task or everything" question** (previously item 1)
  ...
  ([ORCH-SPEC-RESOURCE-REGISTRY.md](ORCH-SPEC-RESOURCE-REGISTRY.md) §4). The original tracker
...
- [GPG-TRUST-LAYER-FAQ.md](USER-GPG-TRUST-LAYER-FAQ.md),
...
- [MAINT-REVIEW-GAP-SCOPE-SEMANTICS-RULING.md](MAINT-REVIEW-GAP-SCOPE-SEMANTICS-RULING.md) — the

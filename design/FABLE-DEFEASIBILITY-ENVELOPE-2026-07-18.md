...
([design/FABLE-OTEL-SENTRY-SPEC.md](FABLE-OTEL-SENTRY-SPEC.md)), will write *model-identity
...
[design/FABLE-OTEL-SENTRY-SPEC.md](FABLE-OTEL-SENTRY-SPEC.md) as revised (the v0/v1/v2
attestation layers a defeat rule would consume); the resurrection-trap precedent in
[design/FABLE-RESERVED-DESIGNS-2026-07-18.md](FABLE-RESERVED-DESIGNS-2026-07-18.md) §1.3.
...
own repository per [design/FABLE-SPA-FEATURE-SPEC.md](FABLE-SPA-FEATURE-SPEC.md)'s pointer;

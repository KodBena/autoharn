...
[`design/MAINT-GPG-TRUST-LAYER.md`](MAINT-GPG-TRUST-LAYER.md). That design signs only the
...
`attest-tags` operator verb; [`design/MAINT-GPG-TRUST-LAYER.md`](MAINT-GPG-TRUST-LAYER.md);
...
[`design/Autoharn.idr`](Autoharn.idr); `AUTOHARN_BACKFLOW.md` (cited as a named artifact, not a

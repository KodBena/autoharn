...
> The generalization of the first ASP adapter ([`LOGIC-LAYER-ASP.md`](ORCH-LOGIC-LAYER-ASP.md))
...
---
*References: [`LOGIC-LAYER-ASP.md`](ORCH-LOGIC-LAYER-ASP.md); `experiments/impedance/`

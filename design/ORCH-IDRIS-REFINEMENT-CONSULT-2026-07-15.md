...
[Autoharn.idr](Autoharn.idr) could be stricter/more polymorphic and that a refined model
...
(Idris 2 v0.7.0, %default total): [RefKernel.idr](RefKernel.idr) (R1-R9 + Refl semantic
witnesses) and [RefUniverse.idr](RefUniverse.idr) (kind-universe pattern), banked beside

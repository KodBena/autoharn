...
`tools/workflow_check.py`, documented in full at [design/workflows/README.md](workflows/README.md))
can actually express. Selection is governed by
[design/FABLE-SHAPED-RECIPES-EXPLORATION-SPEC.md](FABLE-SHAPED-RECIPES-EXPLORATION-SPEC.md)

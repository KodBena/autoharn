...
| AU-10 Non-repudiation | PARTIAL: HMAC stamps bind rows to invocations (s17/s23), and the GPG external-custody layer that would anchor the chain head is built but unarmed ([MAINT-GPG-TRUST-LAYER.md](../../design/MAINT-GPG-TRUST-LAYER.md)). |

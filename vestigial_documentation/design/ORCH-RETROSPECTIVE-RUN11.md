...
[design/RETROSPECTIVE-RUN10.md](ORCH-RETROSPECTIVE-RUN10.md) — ended with **six questions it could
...
six are quoted from [RETROSPECTIVE-RUN10.md](ORCH-RETROSPECTIVE-RUN10.md)'s own "What this record
...
[RETROSPECTIVE-RUN10.md](ORCH-RETROSPECTIVE-RUN10.md), Finding 2), so the convention's power to

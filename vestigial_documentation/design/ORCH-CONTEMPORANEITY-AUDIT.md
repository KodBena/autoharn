...
Audience: orchestrator (this memo's own prose below says "the executor who builds from it" — the same role) (+secondary: maintainer)
...
- **The dishonest disposition, named:** run-5 finding 1 had two halves — no-permit and
  ...
  [CAPABILITIES.md](../../ORCH-CAPABILITIES.md)) fixed the first. That same document's "Honest
...
engines and how they can be leveraged (design/ORCH-possibly-addressable-concerns.md, including

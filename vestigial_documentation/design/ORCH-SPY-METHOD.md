...
- [design/ORCH-ABC-AUDIT-LOOP-RECIPE.md](../../user-guide/ORCH-ABC-AUDIT-LOOP-RECIPE.md) -- the synchronous-dispatch
...
- [design/MAINT-COUNTERSIGN-CLOSE-SEMANTICS-SPEC.md](../../design/MAINT-COUNTERSIGN-CLOSE-SEMANTICS-SPEC.md)

...
- **3d. The attestation merge-seam rule (codify the precedent).** A git merge can
  ...
  [ORCH-ABC-AUDIT-LOOP-RECIPE.md](../../user-guide/ORCH-ABC-AUDIT-LOOP-RECIPE.md)) reads the merged
...
- Branch attribution via the journal's working-directory field is evidence-grade, not
  ...
  ([MAINT-GPG-TRUST-LAYER.md](../../design/MAINT-GPG-TRUST-LAYER.md) §4: the maintainer GPG-signs
...
[ORCH-ABC-AUDIT-LOOP-RECIPE.md](../../user-guide/ORCH-ABC-AUDIT-LOOP-RECIPE.md)'s integrator guidance).
...
[`bootstrap/QUICKSTART.md`](../../user-guide/QUICKSTART.md) for a checkout made before this mechanism
existed. `bootstrap/QUICKSTART.md` was chosen over the adopter-facing
[`USER-CONFIGURATION.md`](../../user-guide/USER-CONFIGURATION.md) because `attestations/*.jsonl` and `BACKLOG.md`
...
[design/ORCH-ABC-AUDIT-LOOP-RECIPE.md](../../user-guide/ORCH-ABC-AUDIT-LOOP-RECIPE.md)'s new "Merging: the integrator's

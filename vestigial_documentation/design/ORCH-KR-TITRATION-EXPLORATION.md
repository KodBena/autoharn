...
[USER-RETROSPECTIVE-RECIPE.md](../../user-guide/USER-RETROSPECTIVE-RECIPE.md) §6, banked in
...
- **Stage 0 — the process rule, zero build.** Adopt §4's amended rule for resolved collisions:
  ...
  [ORCH-ABC-AUDIT-LOOP-RECIPE.md](../../user-guide/ORCH-ABC-AUDIT-LOOP-RECIPE.md) §"The merge convention

...
- **What gets signed, root provisioning:** the deployment's identity (name, creation timestamp,
  ...
  [`ORCH-DEPLOYMENT-PINNING.md`](../../design/ORCH-DEPLOYMENT-PINNING.md), for what "which commit" means once
...
- The migration/composition point named in the companion note: recording *which* pinned autoharn
  commit performed a given recovery, once [`ORCH-DEPLOYMENT-PINNING.md`](../../design/ORCH-DEPLOYMENT-PINNING.md)
...
[`ORCH-DEPLOYMENT-PINNING.md`](../../design/ORCH-DEPLOYMENT-PINNING.md) lands, "which version of autoharn ran
...
- [`design/ORCH-DEPLOYMENT-PINNING.md`](../../design/ORCH-DEPLOYMENT-PINNING.md) — the composing design note

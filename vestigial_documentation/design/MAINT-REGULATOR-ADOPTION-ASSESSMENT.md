...
governing documents ([OPERATING-CARD.md](../../user-guide/ORCH-OPERATING-CARD.md),
...
Every mechanism of [design/GPG-TRUST-LAYER.md](../../design/MAINT-GPG-TRUST-LAYER.md) is implemented and
...
([GPG-TRUST-LAYER.md](../../design/MAINT-GPG-TRUST-LAYER.md) §1) — exist today for nothing real. "Append-only
...
The "live verbs" model ([OPERATING-CARD.md](../../user-guide/ORCH-OPERATING-CARD.md), "What this is") means
...
domain" ([GPG-TRUST-LAYER.md](../../design/MAINT-GPG-TRUST-LAYER.md) §1). Nuclear-culture independence
...
1. **Generate the real maintainer keypair** (hardware token per
   [GPG-TRUST-LAYER-FAQ.md](../../user-guide/USER-GPG-TRUST-LAYER-FAQ.md)), commit `law/keys/maintainer.asc`,
...
13. **The trust-domain decision**: either engineer a second channel outside the single
    ...
    [GPG-TRUST-LAYER.md](../../design/MAINT-GPG-TRUST-LAYER.md) §5 already designs; or an
...
- [design/GPG-TRUST-LAYER.md](../../design/MAINT-GPG-TRUST-LAYER.md) and
  [design/GPG-TRUST-LAYER-FAQ.md](../../user-guide/USER-GPG-TRUST-LAYER-FAQ.md) — the built-but-unarmed layer
  Tier 1 arms.

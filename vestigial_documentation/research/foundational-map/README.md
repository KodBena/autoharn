...
- [01-choco-adr-0011-mechanization.md](../../../research/foundational-map/01-choco-adr-0011-mechanization.md) — choco/ADR-0011-mechanization (chocofarm's "Mechanization Discipline" tenet — the harness north star)
- [02-omega-adr-0011-mechanization-discipline.md](../../../research/foundational-map/02-omega-adr-0011-mechanization-discipline.md) — omega/ADR-0011 Mechanization Discipline (vs chocofarm fork) + meta-review cadence
...
- [04-chocofarm-perf-investigation-discipline.md](../../../research/foundational-map/04-chocofarm-perf-investigation-discipline.md) — chocofarm perf-investigation discipline (ADR-0009) + execution stamina (ADR-0013) + executor second-opinion (ADR-0014), and the throughput_research provenance DB that already mechanizes part of ADR-0009
- [05-omega-adr-0009-performance-investigation-discipline.md](../../../research/foundational-map/05-omega-adr-0009-performance-investigation-discipline.md) — omega/ADR-0009 Performance Investigation Discipline — perf-number provenance/attribution (harness Pillar 2)
- [06-omega-work-status-sql-anti-corruption-layer.md](../../../research/foundational-map/06-omega-work-status-sql-anti-corruption-layer.md) — omega / work-status SQL anti-corruption layer (the key precedent for the harness's SQL layer)
- [07-omega-existing-lint-gates.md](../../../research/foundational-map/07-omega-existing-lint-gates.md) — omega/existing-lint-gates
- [08-cross-benchmark-attribution-today.md](../../../research/foundational-map/08-cross-benchmark-attribution-today.md) — cross/benchmark-attribution-today (Pillar 2 — provenance/accountability ledger)

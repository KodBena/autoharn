...
§3b's below — read [design/USER-WORK-STATUS-OFFERING.md](design/USER-WORK-STATUS-OFFERING.md)
...
§5](design/USER-GPG-TRUST-LAYER-FAQ.md#5-ceremony-2--signed-commissions) is the copy-paste
...
- **`NO-COMMITTED-KEY`** (only if you use the signing layer, [§5](#5-audit-and-trust)). This means
  ...
  §3](design/USER-GPG-TRUST-LAYER-FAQ.md#3-committing-the-public-key--two-different-places-depending-on-what-youre-signing)
...
- [design/USER-GPG-TRUST-LAYER-FAQ.md](design/USER-GPG-TRUST-LAYER-FAQ.md) — the signing layer's
